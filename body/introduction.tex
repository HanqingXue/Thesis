...
\begin{figure}{\label{fig1}}
  ...
  \begin{minipage}{.95\linewidth}
    ...
    \begin{minipage}{\textwidth}
      ...
      \subfigure{\subfigure[聚集系数计算的示例]{\includegraphics[width=0.35\textwidth]{fig22}}}
      \subfigure{\label{tuopuxishu}}\addtocounter{subfigure}{-2}
      \subfigure{\subfigure[拓扑系数计算的示例]{\includegraphics[width=0.4\textwidth]{toplog}}}
    \end{minipage}
	\caption[fig24]{计算示例图}
  \label{fig24}
  \end{minipage}
...
%\begin{figure}[h]
%\centering
%\includegraphics[width = 0.5\textwidth]{toplog}
...
\begin{figure}[h]
\centering
\includegraphics[width = 0.75\textwidth]{algorithm}
...
\begin{figure}[!htbp]
  ...
  \begin{minipage}{.95\linewidth}
    ...
    \begin{minipage}{\textwidth}
      ...
      \subfigure{\subfigure[节点概要信息]{\includegraphics[width=0.4\textwidth]{tab1}}}
      \subfigure{\label{gaiyao2}}\addtocounter{subfigure}{-2}
      \subfigure{\subfigure[边概要信息]{\includegraphics[width=0.4\textwidth]{tab2}}}
      \subfigure{\label{gaiyao3}}\addtocounter{subfigure}{-2}
      \subfigure{\subfigure[网络信息统计]{\includegraphics[width=0.4\textwidth]{tab3}}}
      \subfigure{\label{gaiyao4}}\addtocounter{subfigure}{-2}
      \subfigure{\subfigure[网络编辑模块]{\includegraphics[width=0.4\textwidth]{tab4}}}
    \end{minipage}
...
当用户点击某个节点时，网络分析结果展示模块会给出选中节点在网络中度、度的中心性、密集中心性、介数中心性的数值。同时在网络可视化模块，我们提供了网络分析按钮，当用户点击这个按钮时，分析结果会在该模块以柱状统计图的形式给出，分析包括度分布、最短路径分布等如图\ref{juti5}所示。
